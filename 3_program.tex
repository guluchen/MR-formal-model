...
The reachability problem of Petri nets with inhibitor arcs can be reduced to the reachability problem of the reducer programs, which is in turn easily reduced to the commutativity problem.
