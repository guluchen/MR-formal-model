...
\footnote{We found some minor bugs in the conference version. They are fixed in the current version by adding to the end of each data word a special symbol $\wend$.}
\end{abstract}
