...
%
& =  & (\alpha^{(2)}_{j,0}+\alpha^{(2)}_{j,1} \alpha^{(1)}_{j,0})+ (\alpha^{(2)}_{j,0}\alpha^{(1)}_{j,0}) o_j + \\
%
& & \sum \limits_{j' \le k, \pi_1(j')=j'} (\alpha^{(2)}_{j,0} \beta^{(1)}_{j,j'} + \beta^{(2)}_{j,j'}) d^{(0)}_{j'} + \sum \limits_{j' \le k, \pi_1(j') \neq j'} (\alpha^{(2)}_{j,0} \beta^{(1)}_{j,j'}) d^{(0)}_{j'}  \\
& & + \sum \limits_{j' > k, j' \in \rng(\pi_1)} (\alpha^{(2)}_{j,0} \gamma^{(1)}_{j,j'} + \beta^{(2)}_{j,\pi^{-1}(j')}) d^{(1,1)}_{j'} +\\
%
& & \sum \limits_{j' > k, j' \not \in \rng(\pi_1)} (\alpha^{(2)}_{j,0} \gamma^{(1)}_{j,j'}) d^{(1,1)}_{j'} + 
 \gamma^{(2)}_{j,1} d^{(2,1)}_1 +\dots + \gamma^{(2)}_{j,r_2} d^{(2,1)}_{r_2}.
\end{array}
\] 
...
XXX: the analysis of a single cycle next.
