...
\newcommand*\circled[1]{
	\mathchoice
	{\tikz[baseline=(char.base)]{\node[draw,inner sep=0pt, scale=0.7,ellipse] (char) {\small $#1$};}}
	{\tikz[baseline=(char.base)]{\node[draw,inner sep=0pt, scale=0.7,ellipse] (char) {\small $#1$};}}
	{\tikz[baseline=(char.base)]{\node[draw,inner sep=0pt, scale=0.7,ellipse] (char) {\tiny $#1$};}}
	{\tikz[baseline=(char.base)]{\node[draw,inner sep=0pt, scale=0.5,ellipse] (char) {\tiny $#1$};}}
	}
