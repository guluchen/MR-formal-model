...
\end{itemize}
Consequently, in each of the four situations aforementioned, we always get a contradiction. We conclude that the assumption is false $\Ss'$ is indeed generalized-flat.
\qed
\end{proof}
