...
For each reducer program $p$, one can construct an equivalent SNT $\Ss$ where the number of states and the maximum number of simple cycles in nontrivial SCCs of the transition graph are at most exponential w.r.t. the number of branching statements in $p$. 
\end{proposition}
