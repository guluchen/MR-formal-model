...
An SNT $\Ss$ is said to be \emph{transition-enabled} if each path in $\Ss$ that ends with a $\triangleright$-transition is feasible. We assume that all SNTs considered in this paper are transition enabled.
