...
Given a data word $l=d_1\ldots d_n$ and $\sigma \in S_n$, we lift $\sigma$ to list by defining $\sigma(l)=d_{\pi(1)} \ldots d_{\pi(n)}$ and call $\sigma(l)$ a permutation of $l$.