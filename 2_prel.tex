...
For a function $\rho$, let $\dom(\rho)$ and $\rng(\rho)$ denote the \emph{domain}  and \emph{range} of $\rho$, respectively. We use $\rho_\bot$ to denote a function with empty domain. 
