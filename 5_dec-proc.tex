...
\noindent{\it Complexity analysis of Step I}. Since $\sumf^{(H,\sval_\bot)}$ can be computed in polynomial time from $H$, it follows that Step I can be done in polynomial time.
