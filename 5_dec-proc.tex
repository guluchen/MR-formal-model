...
We then check in Step II the coefficients containing $\ell$ in the output expression is non-zero. If this does not happen, then we show in Step III that the problem can be reduced to a finite state reachability problem and thus can be easily decided.
